...
import { type FileFinderStatic, loadSdk, SCAN_TIMEOUT_MS } from "./sdk.ts";
...
export class FilePickerFactory {
	...
	private openWithDbFallback(FileFinder: FileFinderStatic, options: PickerOptions): Result<FileFinderApi> {
