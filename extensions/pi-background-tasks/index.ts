...
export default function backgroundTasks(pi: ExtensionAPI): void {
	...
	pi.registerTool({
		...
		promptGuidelines: [
			"After starting a background_task, continue independent work or end the turn; completion will be delivered and wake you again. DO NOT sleep or poll to wait!",
