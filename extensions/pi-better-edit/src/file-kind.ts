...
const TEXT_TYPES = new Set<string>(["application/rtf", "application/xml", "application/x-ms-regedit"]);
...
export async function loadFileKindAndText(filePath: string, options?: LoadFileOptions): Promise<LFile> {
