...
export const CLINEPASS_ERROR_MESSAGES: Record<ClinePassErrorType, string> = {
	...
	auth_expired: "ClinePass authentication expired. Run `pi /login` and select ClinePass to refresh your credentials.",
	rate_limited: "ClinePass rate limit reached. Wait a moment and try again, or upgrade your plan at app.cline.bot.",
